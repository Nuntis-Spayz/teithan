/* ----------------------------------------------------------------------------------
 *   _      (̅_) _  |‾| gui text editor    (c) Sevarian  2022.04.30   v00.00.02
...
{ let _t = this;
  ...
  this.alloptions='';
  // compresssion functions from lz-string.js (c)2013 Pieroxy <pieroxy@pieroxy.net>
  _t.keyStrBase64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
  _t.keyStrUriSafe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$";
  _t.baseReverseDic = {};
  _t.settings=[];
  ...
  */
  ...
  _t._compress=(uncompressed, bitsPerChar, getCharFromInt)=> {
